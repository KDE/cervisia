...
QString CvsRepository::cvsClient() const
{
...
QString CvsRepository::rsh() const
{
    return d->rsh;
}


QString CvsRepository::server() const
{
    return d->server;
}


bool CvsRepository::setWorkingCopy(const QString& dirName)
{
...
QString CvsRepository::workingCopy() const
{
    return d->workingCopy;
}


QString CvsRepository::location() const
{
    return d->location;
}


void CvsRepository::slotConfigDirty(const QString& fileName)
{
...
void CvsRepository::Private::readConfig()
{
